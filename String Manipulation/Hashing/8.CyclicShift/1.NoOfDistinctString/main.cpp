//given a string , you need to answer how many distinct string possible by cyclic shift of the given string
//sample input: abcd
//output: 4(abcd, bcda, cdab, dabc)
//complexity: O(N * logN)
#include<bits/stdc++.h>
using namespace std;
...
int main(){
    ...
    s += s;     //abcd+abcd     //  *** to much important
